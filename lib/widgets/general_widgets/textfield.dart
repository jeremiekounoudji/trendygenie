  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: obscureText != null 
        ? Obx(() {
            // Check if the RxBool is still valid before accessing it
            try {
              return _buildTextFormField(obscureText!.value);
            } catch (e) {
              // If RxBool is disposed, use false as default
              return _buildTextFormField(false);
            }
          })
        : _buildTextFormField(false),
    );
  }
