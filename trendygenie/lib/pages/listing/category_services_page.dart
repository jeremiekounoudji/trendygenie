...
class _CategoryServicesPageState extends State<CategoryServicesPage> {
  ...
  void initState() {
    ...
    // Fetch services here instead of in the FutureBuilder
    WidgetsBinding.instance.addPostFrameCallback((_) {
      servicesController.fetchServices(widget.categoryId);
    });
  }
  ...
  void _onScroll() {
    if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent) {
      servicesController.fetchServices(widget.categoryId, loadMore: true);
    }
  }
              ...
              child: Padding(
                ...
                child: Obx(() {
                  ...
                  if (services.isEmpty) {
                    return Center(
                      child: CustomText(
                        text: servicesController.error.value.isNotEmpty 
                          ? servicesController.error.value
                          : 'No services found',
                        color: firstColor,
                        fontSize: 14,
